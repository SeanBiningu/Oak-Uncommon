...
import { registerParticipant, sendRegistrationConfirmation } from '../lib/eventApi';
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      if (isSupabaseConfigured) {
        ...
        // Email delivery is optional until the Edge Function and mail provider are deployed.
        sendRegistrationConfirmation(registered.id).catch(() => undefined);
      } else {
